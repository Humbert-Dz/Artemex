...
INSERT INTO `orders` VALUES (1,'2023-10-14 00:00:00',NULL,0,1,19,99.00,0),(2,'2023-10-14 00:00:00',NULL,1,2,20,45.00,1),(3,'2023-10-14 00:00:00',NULL,1,3,19,176.00,0),(4,'2023-10-14 00:00:00','2023-11-30 08:02:02',1,4,20,50.00,0),(5,'2023-10-14 00:00:00',NULL,0,5,19,16.00,0),(6,'2023-10-14 00:00:00',NULL,1,6,20,75.00,0),(7,'2023-10-14 00:00:00',NULL,0,7,19,6.00,0),(8,'2023-11-15 00:00:00','2023-11-30 08:02:08',1,2,20,297.00,0);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`beto`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `info_admins` AS select `adm`.`id` AS `id`,`u`.`name` AS `name`,`u`.`lastname` AS `lastname`,`u`.`second_lastname` AS `second_lastname`,`u`.`phone` AS `phone`,`u`.`email` AS `email`,`u`.`password` AS `password` from (`users` `u` join `administrators` `adm` on((`u`.`id` = `adm`.`id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-11-30  2:56:38
