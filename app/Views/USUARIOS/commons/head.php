      ...
      tailwind.config = {
        theme: {
          extend: {
            ...
            backgroundImage: {
              product:
                "url(<?php echo base_url('src/backgrounds/product.svg') ?>)",
              inform:
                "url(<?php echo base_url('src/backgrounds/informe.svg') ?>)",
              packages:
      ...
      <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start">
            ...
            <a href="<?= base_url('usuario/inicio') ?>" class="flex ml-2 md:mr-24">
          ...
          <a href="<?= base_url('/logout') ?>" class="flex items-center p-2 text-white rounded-lg bg-slate-500 hover:bg-slate-600 active:scale-95 active:scale-95">
            ...
            <span class="flex-1 ml-3 whitespace-nowrap text-sm">Inciar sesión</span>
          </a>
        </div>
      </div>
    </nav>
    ...
    class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-[#131921] dark:border-gray-700"
      ...
      <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-[#131921]">
        <ul class="space-y-2 font-black text-base">
          <li>
            <a
              href="<?= base_url('usuario/inicio')?>" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group active:scale-95">
