...
<html lang="es">
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url('src/ajolote.svg')?>" type="image/svg+xml" />
    <!-- !CDN -->
    ...
    <script>
      tailwind.config = {
        theme: {
          extend: {
            backgroundImage: {
              login: "url('<?php echo base_url('src/backgrounds/fondo_login.svg')?>')",
            },
            fontFamily: {
              titan: ["titan One"],
              raleway: ["raleway"],
  ...
  <body class="h-screen bg-[#131921] flex items-center justify-center">
    ...
    <div class="w-full h-full flex flex-col items-center justify-evenly gap-2">
        <div class="mb-6 w-4/5 text-center">
            <figure>
                <img src="<?php echo base_url('src/ajolote.svg')?>" alt="ARTEMEX logo" class="w-1/2 mx-auto mb-2">
