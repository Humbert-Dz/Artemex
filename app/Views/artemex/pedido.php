            ...
            <form action="<?php ?>" method="post" class="basis-1/2 h-full">
                <div class="flex gap-2 h-full">
                    <select id="filtro" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-[5px] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                        <option value="pedidos_enviados">Pedidos enviados</option>
                        <option value="pedidos_por_enviar">Pedidos por enviar</option>
                        <option value="pedidos_por_confirmar">Pedidos por confirmar</option>
        ...
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <a href="#" type="button" class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 cursor-pointer">
                        Sí, estoy seguro
                    </a>
