...
<div class="w-full">
    ...
    <div class="w-full h-[32px] flex gap-x-3 mb-7">
            <form action="<?= base_url('producto/buscar') ?>" method="post" class="basis-1/2 h-full">   
                <div class="relative">
            ...
            <form action="<?= base_url('producto/filtrado') ?>" method="post" class="basis-1/2 h-full">
    ...
    <div class="w-full flex flex-col gap-2 justify-center items-center mb-7">
        ...
        if (count($parts) >= 2 && $parts[1] == ('buscar' || 'filtrado' ) ):?>
            <a href="<?= base_url('/producto') ?>" class="place-items-start-start text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-1 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 cursor-pointer">Reestablecer búsqueda</a>
        <?php endif;?>
    </div>
                ...
                <?php foreach($productos as $producto): ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="p-1 w-[150px]">
                            <img src="<?= base_url("{$producto['image']}")?>" alt="imagen de producto" class="w-full rounded-lg shadow-chica">
                        </td>
                        <td class="px-2 py-4">
              ...
              <form action="<?= base_url('producto/agregar') ?>" method="post" enctype="multipart/form-data">
                  <div class="grid gap-6 mb-4 sm:grid-cols-2">
                      <div>
                          ...
                          <input type="text" name="name" id="name" minlength="2" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Nombre del producto" required="">
                      </div>
                      <div>
                      ...
                      <div class="flex gap-2">
                        <div>
                          ...
                          <input type="number" name="cost" id="cost" min="5" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="$" required="">
                        </div>
                        <div>
                          <label for="precio" class="mb-2 text-sm font-medium text-gray-900 dark:text-white">Precio venta</label>
                          <input type="number" name="precio" id="precio" min="5" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="$" required="">
                        </div>
                      </div>
                      <div class="flex gap-2">
                          <div class="basis-1/2">
                            <label for="stock" class="mb-2 text-sm font-medium text-gray-900 dark:text-white">Cantidad</label>
                            <input type="number" name="stock" id="stock" min="0" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="#" required="">
                          </div>
                          <div class="basis-1/2">
                      ...
                      <div>
                          ...
                          <input type="date" name="caducidad" id="caducidad" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required="">
                      </div>
                      <div>
                            <label for="peso" class="mb-2 text-sm font-medium text-gray-900 dark:text-white">Peso</label>
                            <input type="number" name="peso" id="peso" min="0" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="#" required="">
                          </div>
        ...
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <a type="button" id="eliminar" href="<?= base_url('producto/eliminar/') ?>"  class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
                        Sí, estoy seguro
                    </a>
