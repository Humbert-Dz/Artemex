      ...
      <div class="relative p-4 w-full max-w-2xl h-full md:h-auto flex justify-center items-center">
          ...
          <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
              ...
              <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                  ...
                  <a href="<?= base_url('/producto') ?>" class="relative -top-5 -right-5 active:scale-95 text-gray-400 bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:text-white">
              ...
              <!-- Modal body -->
              <form id="actualizar" action="<?= base_url('producto/actualizar/') . $product[0]['id'] ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="flex justify-evenly">
                    <a href="<?= base_url('/producto') ?>" class="text-black text-base active:scale-95 text-white flex items-center bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-medium rounded-lg px-5 py-2.5 text-center mr-2 mb-2">
